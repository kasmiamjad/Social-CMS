...
/**
 * Live-ish view of WhatsApp connection/send events (connects, disconnects,
 * retries, send successes/failures) — so what's happening can be watched
 * from the browser instead of SSHing in to read pm2 logs.
 */
    ...
    <div className="max-w-4xl">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-text-muted mt-1">
          Live-ish view of connects, disconnects, and send attempts. Refreshes every 2 seconds — send a
          message from another tab and watch it appear here.
        </p>
      </div>
