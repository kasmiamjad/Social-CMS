        ...
        {isCompleted && existingBooking ? (
          ...
          <>
                  ...
                  return (
                    <button
                      ...
                      className={`inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg border text-sm font-medium transition-colors ${
                        isSel ? "border-primary bg-primary text-black" : "border-border hover:border-primary text-foreground"
                      }`}
                    >
            ...
            <button
              ...
              className="w-full mt-6 inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-primary hover:bg-primary-hover text-black text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
